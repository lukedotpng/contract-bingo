...
export const createBoardToContract = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (await boardContainsContract(ctx, args.boardId, args.contractId)) return ResponseStatus.BAD_REQUEST;
...
export const addBoardToContractSubmission = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (btc.submissionIds.includes(args.submissionId)) return ResponseStatus.BAD_REQUEST;
...
export const removeBoardToContractSubmission = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        if (btc.submissionIds == null || !btc.submissionIds.includes(args.submissionId)) return ResponseStatus.BAD_REQUEST;
